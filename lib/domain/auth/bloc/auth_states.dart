...
abstract class AuthState with _$AuthState {
  ...
  const factory AuthState.logedIn(String login, String password, String email, UserPersonalDataModel? data) = _$AuthLogedInState;
  const factory AuthState.signedUp(String login, String password, String email) = _$AuthSignedUpState;
