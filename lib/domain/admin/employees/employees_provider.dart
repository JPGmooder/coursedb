...
class EmployeesProvider {
  static QueryOptions _loadEmployees() {
    String query = r'''
query MyQuery {
  employee(where: {userlogin: {_neq: "Admin"}}) {
    userlogin
    user {
      personaldatum {
        personallname
...
''';
  ...
  static Future<QueryResult<Object?>> loadEmployees() async {
    var response = await AppsGraphClient.client.query(_loadEmployees());
    return response;
  }
...
//   }
  ...
  static MutationOptions _updateEmployee({
    ...
    String query = r'''
mutation MyMutation($p_postname: String!, $p_userlogin: String!, $status: employeestatus!) {
...
''';
  ...
  static Future<QueryResult<Object?>> updateEmployee(
    ...
    var response = await AppsGraphClient.client.mutate(_updateEmployee(
        postName: postName, userLogin: userLogin, status: status));
    return response;
  }
